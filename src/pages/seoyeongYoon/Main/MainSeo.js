    ...
    <div className="container">
      <header className="header">
        <div className="wrapper">
          <div className="logo">
            <a href="#">
              <img src="/image/seoyeongYoon/images/camera.png" alt="camera" />
            </a>
          ...
          <nav className="nav_icon">
            <ul className="nav_icon_groups">
              <li>
                <a href="#">
                  <img
                    src="/image/seoyeongYoon/images/compass.png"
                    alt="compass"
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    src="/image/seoyeongYoon/images/heart_1.png"
                    alt="heart"
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="/image/seoyeongYoon/images/user.png" alt="user" />
                </a>
              </li>
            </ul>
          </nav>
